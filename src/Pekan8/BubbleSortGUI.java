...
public class BubbleSortGUI extends JFrame {
	...
	private void performStep() {
		...
		if (array[j] > array[j + 1]) {
			...
			array[j] = array[j + 1];
			array[j + 1] = temp;
			  stepLog.append("Langkah ke-").append(stepCount)
              .append(": Menukar elemen ke-").append(i + 1)
              .append(" dengan ke-").append(i + 2)
              .append(" (").append(array[i]).append(", ").append(array[i + 1]).append(")\n");
   } else {
       stepLog.append("Langkah ke-").append(stepCount)
              .append(": Tidak ada pertukaran antara ke-").append(i + 1)
              .append(" dan ke-").append(i + 2).append("\n");
   }

   stepLog.append("Hasil: ").append(arrayToString(array)).append("\n\n");
   stepArea.setText(stepLog.toString());
